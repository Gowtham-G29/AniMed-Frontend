...
import LocationSelectionConfirmationModal from "../components/LocationSelectionConfirmationModal";
...
function AnimalDetailsRegister({
  ...
  return (
    <div>
      {showLocationModal && (
        <LocationSelectionConfirmationModal
          handleLocationChoice={handleLocationChoice}
        />
      )}

      {openManualSelectLocation && <ManualSelectMapModal setManualCoords={setManualCoords} setOpenManualSelectLocation={setOpenManualSelectLocation}/>}
